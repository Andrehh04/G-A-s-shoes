			...
			<hr>
				...
				?>	        
			        ...
			        while($riga = $ris_query->fetch_assoc())
			        	{
			        		$idprod=$riga['idprod'];
			        		echo'<div id="pro" class="col-3"><a href="prodottoUtente.php?idprod=' . $idprod .'"><img style="background-color:#ededed;" src="' . $riga['immagine'] . ' " class="d-block w-100" alt="."></a><br><p><b>'. $riga['marca'] . '</b> ' . $riga['descrizione'] . '<br><b>' . $riga['prezzo'] . '$</b></p></div>';
			        	}	
