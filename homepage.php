...
<body>
	...
	<!-- header -->
	 	 ...
	 	 <div class="row" style="font-family: 'Times New Roman', serif;">
	 	 	...
	 	 	<p align="center">
	 	 		il nostro motto è sempre stato "<b>Beautiful people wear beautiful shoes</b>"<br>perchè crediamo che le scarpe che si indossano possano dire <br>molte cose su una persona. 
	 	 	</p>
		      ...
		      <div class="row">
				...
				for ($idprod=1; $idprod < 8; $idprod++) { 
					...
					if ($ris_query->num_rows > 0) {
						...
						echo'<div id="pro" class="col-sm-3"><a href="prodotto.php?idprod=' . $idprod .'"> <img style="background-color:#ededed;" src="' . $riga['immagine'] . ' " class="d-block w-100" alt="."></a><br><p><b>'. $riga['marca'] . '</b> ' . $riga['descrizione'] . '<br><b>' . $riga['prezzo'] . '$</b></p></div>';			            
			        }
				}		        
			?>
